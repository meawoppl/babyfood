...
class GerberWriter:
    ...
    """
    def __init__(self, pathOrFlo, xFmt=(4, 4), yFmt=(4, 4), units="MM", comment=None, polarity="D"):
        ...
        self._uc = {"MM": mm, "IN": inch}[units]
        self._units = units
        self._formatSet = True
